...
abstract class $DetailsModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'capacity') List<String> capacity,
      @JsonKey(name: 'color') List<String> color,
      @JsonKey(name: 'id') String id,
      @JsonKey(name: 'images') List<String> images,
      @JsonKey(name: 'isFavorites') bool isFavorites,
      @JsonKey(name: 'price') int price,
      @JsonKey(name: 'rating') double rating,
      @JsonKey(name: 'sd') String sd,
      @JsonKey(name: 'ssd') String ssd,
...
class _$_DetailsModel implements _DetailsModel {
  const _$_DetailsModel(
      ...
      @JsonKey(name: 'isFavorites') required this.isFavorites,
      @JsonKey(name: 'price') required this.price,
      @JsonKey(name: 'rating') required this.rating,
      @JsonKey(name: 'sd') required this.sd,
      @JsonKey(name: 'ssd') required this.ssd,
